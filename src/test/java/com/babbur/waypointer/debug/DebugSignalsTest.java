...
class DebugSignalsTest {
    ...
    void crystalHollowsLineIncludesLobbyAndCompassState() {
        String line = DebugSignals.crystalHollowsLine(
                true, "mini123A", 17, 4, CrystalHollowsStructure.MINES_OF_DIVAN,
                new CrystalHollowsPosition(606, 88, 265), "NEED_SECOND_USE", 1, "ray_captured");
        ...
        assertTrue(line.contains("sidebarStructure=MINES_OF_DIVAN"));
        assertTrue(line.contains("divanCentre=CrystalHollowsPosition[x=606, y=88, z=265]"));
    ...
    void crystalHollowsLineLabelsUnknownIdentityAndDay() {
        String line = DebugSignals.crystalHollowsLine(
                false, null, -1, 0, null, null, "not installed", 0, null);

        assertTrue(line.contains("serverId=(none)"));
        assertTrue(line.contains("day=unknown"));
        assertTrue(line.contains("sidebarStructure=(none)"));
        assertTrue(line.contains("divanCentre=(none)"));
