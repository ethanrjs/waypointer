...
import static dev.ethan.waypointer.screen.settings.Setting.Store.DUNGEON;
import static dev.ethan.waypointer.screen.settings.Setting.Store.MAIN;
        ...
        return Category.of("system", "System",
                ...
                Group.plain("Diagnostics",
                        Setting.action(ACTION_PERF_TEST, "Performance stress test",
                                "Runs a ~20 second benchmark of Waypointer's render features and measures the FPS "
                                        + "cost of each. Your settings are restored when it finishes; "
